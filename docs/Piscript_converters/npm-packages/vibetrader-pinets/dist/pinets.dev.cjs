...
class ScopeManager {
  ...
  contextBoundVars = /* @__PURE__ */ new Set();
  arrayPatternElements = /* @__PURE__ */ new Set();
  rootParams = /* @__PURE__ */ new Set();
  localSeriesVars = /* @__PURE__ */ new Set();
  varKinds = /* @__PURE__ */ new Map();
...
class Context {
  ...
  static _deprecationWarningsShown = /* @__PURE__ */ new Set();
  idx = 0;
  params = {};
  const = {};
  var = {};
...
class PineTS {
  ...
  _transpiledCode = null;
  get transpiledCode() {
    return this._transpiledCode;
  }
  _isSecondaryContext = false;
  markAsSecondary() {
...
//# sourceMappingURL=pinets.dev.cjs.map
